...
def countStat(dirPath):
    ...
    print(trace_ohr) 
    print(trace_dw)  
    pickle.dump(trace_ohr, open("/mydata/output-production/eu-subtraces/"+trace+"/ohr-result.pkl", "wb"))
    pickle.dump(trace_dw, open("/mydata/output-production/eu-subtraces/"+trace+"/dw-result.pkl", "wb"))
