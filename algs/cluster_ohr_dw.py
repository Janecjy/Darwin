...
def feature_cluster(thres):
    ...
    best_result = pickle.load(open("/mydata/results/oh_dw_coarse_best_result_"+thres+".pkl", "rb"))
    ...
    pickle.dump(kmeans_model, open("/mydata/results/ohr_dw_kmeans_"+thres+".pkl", "wb"))
    ...
    pickle.dump(bestSetDict, open("/mydata/results/ohr_dw_cluster_experts_"+thres+".pkl", "wb"))
